...
contract SpectrrFiDividendToken is ERC20Dividends, Ownable, ReentrancyGuard {
    ...
    constructor(
		...
		/// @dev OnlyOwner modifier restricts call to only SpectrrFi Contract Address
		/// @param _amount The amount to distribute between SpectrrDividendToken holders
    function distributeDividends(uint256 _amount) external onlyOwner {
		...
		/// @param _account The address on which dividends will be withdrawn
